...
class Model():
    def __init__(self, numOfAgent, numOfInfo):
        ...
        self.knowledgeExchangePerStep = [0 for i in range(defs.numOfSteps)]
    ...
    def initialize(self):
        ...
        for agent in self.agents:
            ...
            agent.randomizeSecretiveness() #result_4, result_5 deactivate, result_6 activate
    ...
    def step(self):
        ...
        if(info2 != -1):
            ...
            if(infoExchangeHappened == True):
                ...
                self.knowledgeExchangePerStep[self.stepCount] = self.knowledgeExchangeCount
